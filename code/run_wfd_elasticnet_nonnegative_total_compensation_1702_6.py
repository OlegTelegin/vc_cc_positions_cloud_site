...
def main() -> None:
    ...
    selected_df.to_csv(
        output_dir / "elasticnet_wfd_1702_6_total_compensation_selected_weights.csv", index=False
    )
    ...
    pred_df.to_csv(output_dir / "elasticnet_wfd_1702_6_total_compensation_test_predictions.csv", index=False)
    ...
    with (output_dir / "elasticnet_wfd_1702_6_total_compensation_results.txt").open(
        "w", encoding="utf-8"
    ) as fout:
    ...
    print(f"Saved: {output_dir / 'elasticnet_wfd_1702_6_total_compensation_selected_weights.csv'}")
    print(f"Saved: {output_dir / 'elasticnet_wfd_1702_6_total_compensation_test_predictions.csv'}")
    print(f"Saved: {output_dir / 'elasticnet_wfd_1702_6_total_compensation_results.txt'}")
