...
local sm_type "selected_vars_gbrl_salary_1000"
...
import delimited "`project_dir'/data/miqp_gbrl_1000_salary_fe.csv", clear varnames(1)
...
quietly count
if r(N) == 0 {
    di as error "No selected variables found in `project_dir'/data/miqp_gbrl_1000_salary_fe.csv"
    exit 2000
}
...
save "..\output\wfd_regressions_by_type_22_miqp_gbrl_salary_1000_fe.dta", replace
