...
local sm_type "total_compensation_k1000_correlated_w_sm"
local rhs_salary_var "w_sal_k10_8_sel_tcsm"
local rhs_weight_var "w_wgt_k10_8_sel_tcsm"
local rhs_total_comp_var "w_tcmp_k10_8_sel_tcsm"
local rhs_per_salary_var "w_psal_k10_8_sel_tcsm"
local rhs_per_weight_var "w_pwgt_k10_8_sel_tcsm"
local rhs_per_total_comp_var "w_ptcmp_k10_8_sel_tcsm"

* Read selected variables list
import delimited "`project_dir'/data/total_compensation_k1000_correlated_w_sm.csv", clear varnames(1)
...
quietly count
if r(N) == 0 {
    di as error "No selected variables found in `project_dir'/data/total_compensation_k1000_correlated_w_sm.csv"
    exit 2000
}
...
save "`project_dir'/output/wfd_regressions_by_type_13_total_compensation_k1000_correlated_w_sm.dta", replace

di as text "Saved: `project_dir'/output/wfd_regressions_by_type_13_total_compensation_k1000_correlated_w_sm.dta"
