...
save "`project_dir'/output/wfd_regressions_by_type_10_selected_vars_peremp_salary_50.dta", replace

di as text "Saved: `project_dir'/output/wfd_regressions_by_type_10_selected_vars_peremp_salary_50.dta"
