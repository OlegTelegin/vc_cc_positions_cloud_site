...
local sm_type "selected_vars_predict_salary_w_salary_1000"
local rhs_salary_var "w_sal_k10_8_sel_s1000"
local rhs_weight_var "w_wgt_k10_8_sel_s1000"
local rhs_total_comp_var "w_tcmp_k10_8_sel_s1000"
local rhs_per_salary_var "w_psal_k10_8_sel_s1000"
local rhs_per_weight_var "w_pwgt_k10_8_sel_s1000"
local rhs_per_total_comp_var "w_ptcmp_k10_8_sel_s1000"

* Read selected variables list (no weights)
import delimited "`project_dir'/data/selected_vars_predict_salary_w_salary_1000.csv", clear varnames(1)
...
quietly count
if r(N) == 0 {
    di as error "No selected variables found in `project_dir'/data/selected_vars_predict_salary_w_salary_1000.csv"
    exit 2000
}
...
save "`project_dir'/output/wfd_regressions_by_type_8_selected_vars_salary_1000.dta", replace

di as text "Saved: `project_dir'/output/wfd_regressions_by_type_8_selected_vars_salary_1000.dta"
