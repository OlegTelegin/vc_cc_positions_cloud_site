...
def main() -> None:
    ...
    xvars = [f"w_weight_k50_{i}" for i in range(1, 54)]
    ...
    selected_df.to_csv(output_dir / "elasticnet_wfd_1702_6_weight_selected_weights.csv", index=False)
    ...
    pred_df.to_csv(output_dir / "elasticnet_wfd_1702_6_weight_test_predictions.csv", index=False)
    ...
    with (output_dir / "elasticnet_wfd_1702_6_weight_results.txt").open("w", encoding="utf-8") as fout:
        fout.write("Elastic net run on temp_wfd_1702_6.dta\n")
        fout.write(f"Dependent variable: {yvar}\n")
        fout.write("Predictors: w_weight_k50_1-w_weight_k50_53\n")
    ...
    print(f"Saved: {output_dir / 'elasticnet_wfd_1702_6_weight_selected_weights.csv'}")
    print(f"Saved: {output_dir / 'elasticnet_wfd_1702_6_weight_test_predictions.csv'}")
    print(f"Saved: {output_dir / 'elasticnet_wfd_1702_6_weight_results.txt'}")
