...
local sm_type "selected_vars_predict_salary_w_salary_50"
local rhs_salary_var "w_salary_k10_8_sel_salary50"
local rhs_weight_var "w_weight_k10_8_sel_salary50"
local rhs_total_comp_var "w_tcomp_k10_8_sel_salary50"
local rhs_per_salary_var "w_per_salary_k10_8_sel_salary50"
local rhs_per_weight_var "w_per_weight_k10_8_sel_salary50"
local rhs_per_total_comp_var "w_per_tcomp_k10_8_sel_salary50"

* Read selected variables list (no weights)
import delimited "`project_dir'/data/selected_vars_predict_salary_w_salary_50.csv", clear varnames(1)
...
quietly count
if r(N) == 0 {
    di as error "No selected variables found in `project_dir'/data/selected_vars_predict_salary_w_salary_50.csv"
    exit 2000
}
...
save "`project_dir'/output/wfd_regressions_by_type_6_selected_vars_salary_50.dta", replace

di as text "Saved: `project_dir'/output/wfd_regressions_by_type_6_selected_vars_salary_50.dta"
