...
def main() -> None:
    ...
    by_type_path = project_dir / "output" / "wfd_regressions_by_type_14_elastic_compensation.dta"
    selected_weights_path = project_dir / "output" / "elasticnet_wfd_1702_6_total_compensation_selected_weights.csv"
    correspondence_path = project_dir / "data" / "k50_k1000_correspondence.dta"
    output_path = project_dir / "web" / "data" / "list_by_type_14.csv"
