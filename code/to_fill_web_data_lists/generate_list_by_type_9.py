...
def main() -> None:
    ...
    by_type_path = project_dir / "output" / "wfd_regressions_by_type_9_selected_vars_peremp_count_50.dta"
    selected_vars_path = project_dir / "data" / "selected_vars_predict_peremp_salary_w_count_50.csv"
    correspondence_path = project_dir / "data" / "k50_k1000_correspondence.dta"
    output_path = project_dir / "web" / "data" / "list_by_type_9.csv"
    ...
    # Values look like weight_k50_12; extract the k50 numeric id.
    k50_ids = (
