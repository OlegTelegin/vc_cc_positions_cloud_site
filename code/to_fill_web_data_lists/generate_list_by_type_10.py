...
def main() -> None:
    ...
    by_type_path = project_dir / "output" / "wfd_regressions_by_type_10_selected_vars_peremp_salary_50.dta"
    selected_vars_path = project_dir / "data" / "selected_vars_predict_peremp_salary_w_salary_50.csv"
    correspondence_path = project_dir / "data" / "k50_k1000_correspondence.dta"
    output_path = project_dir / "web" / "data" / "list_by_type_10.csv"
