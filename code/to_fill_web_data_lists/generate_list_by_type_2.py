...
def main() -> None:
    ...
    by_type_path = project_dir / "output" / "wfd_regressions_by_type_2_elastic.dta"
    selected_weights_path = project_dir / "output" / "elasticnet_wfd_1702_6_selected_weights.csv"
    correspondence_path = project_dir / "data" / "k50_k1000_correspondence.dta"
    output_path = project_dir / "web" / "data" / "list_by_type_2.csv"
    ...
    # Variables look like w_salary_k50_20; extract the k50 numeric id.
    k50_ids = (
