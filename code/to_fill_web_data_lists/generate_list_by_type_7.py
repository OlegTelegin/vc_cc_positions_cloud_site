...
def main() -> None:
    ...
    by_type_path = project_dir / "output" / "wfd_regressions_by_type_7_selected_vars_count_1000.dta"
    selected_vars_path = project_dir / "data" / "selected_vars_predict_salary_w_count_1000.csv"
    output_path = project_dir / "web" / "data" / "list_by_type_7.csv"
    ...
    # Values look like weight_k1000_633; extract the k1000 numeric id.
    k1000_ids = (
