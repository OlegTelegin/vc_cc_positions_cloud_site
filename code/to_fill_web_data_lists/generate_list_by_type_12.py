...
def main() -> None:
    ...
    by_type_path = project_dir / "output" / "wfd_regressions_by_type_12_salary_k1000_correlated_w_sm.dta"
    selected_vars_path = project_dir / "data" / "salary_k1000_correlated_w_sm.csv"
    output_path = project_dir / "web" / "data" / "list_by_type_12.csv"
    fallback_sm_type = "salary_k1000_correlated_w_sm"
