...
def main() -> None:
    ...
    by_type_path = project_dir / "output" / "wfd_regressions_by_type_24_elastic_gbrl_compensation_fe.dta"
    selected_weights_path = project_dir / "output" / "elasticnet_wfd_1702_6_compensation_selected_weights_gbrl_fe.csv"
    output_path = project_dir / "web" / "data" / "list_by_type_24.csv"
