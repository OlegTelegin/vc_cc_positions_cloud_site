...
def main() -> None:
    ...
    do_file_path = project_dir / "code" / "run_wfd_regressions_by_type_22_miqp_gbrl_salary_fe.do"
    selected_vars_path = project_dir / "data" / "miqp_gbrl_1000_salary_fe.csv"
    output_path = project_dir / "web" / "data" / "list_by_type_22.csv"
    ...
    # Values look like salary_k1000_89; extract the k1000 numeric id.
    role_k1000 = (
