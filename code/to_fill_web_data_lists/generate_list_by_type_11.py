...
def main() -> None:
    ...
    by_type_path = project_dir / "output" / "wfd_regressions_by_type_11_weight_k1000_correlated_w_sm.dta"
    selected_vars_path = project_dir / "data" / "weight_k1000_correlated_w_sm.csv"
    output_path = project_dir / "web" / "data" / "list_by_type_11.csv"
    ...
    # Values look like w_per_weight_k1000_633; extract the k1000 numeric id.
    k1000_ids = (
