...
def main() -> None:
    ...
    by_type_path = project_dir / "output" / "wfd_regressions_by_type_25_miqp_gbrl_peremp_compensation_1000_fe.dta"
    selected_vars_path = project_dir / "data" / "miqp_gbrl_1000_peremp_compensation_fe.csv"
    output_path = project_dir / "web" / "data" / "list_by_type_25.csv"
    ...
    # Values look like total_compensation_k1000_21; extract the k1000 numeric id.
    role_k1000 = (
