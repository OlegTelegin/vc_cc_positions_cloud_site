...
***d. researcher
preserve
keep if strpos(role_k1000_v3, "researcher")
levelsof role_k1000_v3_num, local(researcher)
restore
***e. scientist
preserve
keep if strpos(role_k1000_v3, "scientist")
levelsof role_k1000_v3_num, local(scientist)
restore
***f. engineer
preserve
keep if strpos(role_k1000_v3, "engineer")
levelsof role_k1000_v3_num, local(engineer)
restore
***g. developer
preserve
keep if strpos(role_k1000_v3, "developer")
levelsof role_k1000_v3_num, local(developer)
restore
***h. technician
preserve
keep if strpos(role_k1000_v3, "technician")
levelsof role_k1000_v3_num, local(technician)
restore
...
foreach num of local researcher {
	post amirpost ("researcher") (`num')
}

foreach num of local scientist {
	post amirpost ("scientist") (`num')
}

foreach num of local engineer {
	post amirpost ("engineer") (`num')
}

foreach num of local developer {
	post amirpost ("developer") (`num')
}

foreach num of local technician {
	post amirpost ("technician") (`num')
}
