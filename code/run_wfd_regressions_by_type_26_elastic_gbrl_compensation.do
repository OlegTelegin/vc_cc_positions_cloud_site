...
local sm_type "elastic_gbrl_compensation"
...
import delimited "`project_dir'/output/elasticnet_wfd_1702_6_compensation_selected_weights_nofe_supportaware.csv", clear varnames(1)
...
quietly count
if r(N) == 0 {
    di as error "No selected variables found in `project_dir'/output/elasticnet_wfd_1702_6_compensation_selected_weights_nofe_supportaware.csv"
    exit 2000
}
...
save "`project_dir'/output/wfd_regressions_by_type_26_elastic_compensation_gbrl.dta", replace

di as text "Saved: `project_dir'/output/wfd_regressions_by_type_26_elastic_compensation_gbrl.dta"
