...
regress w_xsalesmktrawCIQ `rhs_weight_var' i.bucket16, r
post `posth' (5) ("`sm_type'") (_b[`rhs_weight_var']) (e(r2))

regress w_per_xsalesmktrawCIQ `rhs_per_weight_var' i.bucket16, r
post `posth' (6) ("`sm_type'") (_b[`rhs_per_weight_var']) (e(r2))

* 13-18
regress w_xsalesmktrawCIQ `rhs_salary_var' i.bucket16 if total_employment < `perc', r
post `posth' (13) ("`sm_type'") (_b[`rhs_salary_var']) (e(r2))

regress w_xsalesmktrawCIQ `rhs_total_comp_var' i.bucket16 if total_employment < `perc', r
post `posth' (14) ("`sm_type'") (_b[`rhs_total_comp_var']) (e(r2))

regress w_per_xsalesmktrawCIQ `rhs_per_salary_var' i.bucket16 if total_employment < `perc', r
post `posth' (15) ("`sm_type'") (_b[`rhs_per_salary_var']) (e(r2))

regress w_per_xsalesmktrawCIQ `rhs_per_total_comp_var' i.bucket16 if total_employment < `perc', r
post `posth' (16) ("`sm_type'") (_b[`rhs_per_total_comp_var']) (e(r2))

regress w_xsalesmktrawCIQ `rhs_weight_var' i.bucket16 if total_employment < `perc', r
post `posth' (17) ("`sm_type'") (_b[`rhs_weight_var']) (e(r2))

regress w_per_xsalesmktrawCIQ `rhs_per_weight_var' i.bucket16 if total_employment < `perc', r
...
save "`project_dir'/output/wfd_regressions_by_type_18_selected_vars_peremp_salary_50_fe.dta", replace

di as text "Saved: `project_dir'/output/wfd_regressions_by_type_18_selected_vars_peremp_salary_50_fe.dta"
